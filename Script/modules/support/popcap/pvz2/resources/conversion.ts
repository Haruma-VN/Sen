namespace Sen.Script.Modules.Support.PopCap.PvZ2.Resources.Conversion {
    ...
    export abstract class CheckOfficialResources {
            ...
            if (!Number.isInteger(num)) {
                throw new Sen.Script.Modules.Exceptions.WrongDataType(
                    `${Sen.Script.Modules.System.Default.Localization.RegexReplace(
                        ...
                        [`${property}`, `${id}`, `${Sen.Script.Modules.System.Default.Localization.GetString("integer")}`, `${num}`]
                    )}`,
                    property,
                    file_path,
        ...
        protected static CheckWholeData(sub_resource_data: Resource_Structure_Template, file_path: string): sub_resource_data is Resource_Structure_Template {
            if (
                ...
                throw new Sen.Script.Modules.Exceptions.MissingProperty(
                    Sen.Script.Modules.System.Default.Localization.GetString("property_is_null").replace(/\{\}/g, "resources"),
                    "resources",
                    file_path
                );
            }
        ...
        protected static CheckOfficial<Template extends Resources_Group_Structure_Template>(
            ...
            if (!("groups" in resources_group)) {
                throw new Sen.Script.Modules.Exceptions.MissingProperty(
                    Sen.Script.Modules.System.Default.Localization.GetString("property_is_null").replace(/\{\}/g, "groups"),
                    "groups",
                    file_path
                );
            }
        ...
        protected static CheckSubgroupChildrenDataImage<Resource_Template extends Resource_Structure_Template>(
            ...
            if (!("res" in sub_resource_data) || sub_resource_data.res === undefined || sub_resource_data.res === null || sub_resource_data.res === void 0) {
                throw new Sen.Script.Modules.Exceptions.MissingProperty(
                    Sen.Script.Modules.System.Default.Localization.GetString("property_is_null").replace(/\{\}/g, "res"),
                    "res",
                    file_path
                );
            }
        ...
        protected static CheckUnofficialJsonForWork<Template extends res_json>(res_json: Template, file_path: string): res_json is Template {
            if (!("expand_path" in res_json)) {
                throw new Sen.Script.Modules.Exceptions.MissingProperty(
                    Sen.Script.Modules.System.Default.Localization.GetString("property_is_null").replace(/\{\}/g, "expand_path"),
                    "expand_path",
                    file_path
                );
            }
    ...
    export class UnofficialResourceConversion extends CheckOfficialResources {
        private static CheckOfficialPathType<Template extends Resources_Group_Structure_Template>(resource_json: Template): "array" | "string" {
        ...
        private static ConvertOfficialSubgroupFile<Template extends Resource_Structure_Template, Value extends subgroup_children>(
                    ...
                    (Array.isArray(sub_resource_data.resources[index].srcpath) || typeof sub_resource_data.resources[index].srcpath === "string")
                        ? {
                              ...
                              srcpath: Array.isArray(sub_resource_data.resources[index].srcpath)
                                  ...
                                  : ((sub_resource_data.resources[index].srcpath as string).split("\\") as Array<string> & any),
                          }
                        : {
                              type: sub_resource_data.resources[index].type as string,
                              path: Array.isArray(sub_resource_data.resources[index].path)
                        ...
                        if (sub_resource_data.resources[j_index].parent === sub_resource_data.resources[index].id) {
                            res_json_conversion[sub_resource_data.id].packet[sub_resource_data.resources[index].id].data[
                                ...
                                path: Array.isArray(sub_resource_data.resources[j_index].path)
                                    ...
                                    : ((sub_resource_data.resources[j_index].path as string).split("\\") as Array<string> & any),
                            ...
                            subgroup_list[j_index][k_index].image !== null
                                ? Object.values(
                                      this.ConvertOfficialSubgroupContainsAtlas(
                                          resources_group.groups.filter((res) => res.id === subgroup_list[j_index][k_index].name)[0] as any,
                                          file_path
                                      )
                                  )[0]
                                : (Object.values(
        ...
        public static CreateConversion<Required_Template extends Resources_Group_Structure_Template, Res_JSON_Structure extends res_json>(
            file_input: string,
            output_file: string,
            ...
            Sen.Script.Modules.FileSystem.Json.WriteJson<Res_JSON_Structure>(
                output_file,
                this.DoAllProcess<Required_Template, Res_JSON_Structure>(resource_json, file_input, expand_path)
            );
        }
    }
    export class ConvertToOfficial extends CheckOfficialResources {
            ...
            for (let index: number = 0; index < resource_atlas_parent.length; ++index) {
                ...
                manifest_group_for_atlas_and_sprite.resources.push({
                    ...
                    path: expand_path_for_array
                        ...
                        : ((packet.packet[resource_atlas_parent[index]].path as Array<string> & any).join("\\") as string & any),
                ...
                for (let j_index: number = 0; j_index < resource_atlas_children_sprites_id.length; ++j_index) {
                    this.CheckIntegerNumber(
                        (packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].default.ax,
                        "ax",
                        resource_atlas_children_sprites_id[j_index] as string,
                        file_path
                    );
                    this.CheckIntegerNumber(
                        (packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].default.ay,
                        `ay`,
                        resource_atlas_children_sprites_id[j_index],
                        file_path
                    );
                    this.CheckIntegerNumber(
                        (packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].default.ah,
                        `ah`,
                        resource_atlas_children_sprites_id[j_index],
                        file_path
                    );
                    this.CheckIntegerNumber(
                        (packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].default.aw,
                        `aw`,
                        resource_atlas_children_sprites_id[j_index],
                        file_path
                    );
                    manifest_group_for_atlas_and_sprite.resources.push(
                        (packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].default.cols !== undefined &&
                            ...
                            this.CheckIntegerNumber(
                                (packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].default.cols,
                                `cols`,
                                resource_atlas_children_sprites_id[j_index],
                                file_path
                            )
                            ? {
                                  ...
                                  path: expand_path_for_array
                                      ...
                                      : ((packet.packet[resource_atlas_parent[index]].data as any)[resource_atlas_children_sprites_id[j_index]].path.join(
                                            "\\"
                                        ) as string & any),
                                  ...
                                  ax:
                                      ...
                                      (packet.packet[resource_atlas_parent[index]] as any).data[resource_atlas_children_sprites_id[j_index]].default.ax > 0
                                          ? (packet.packet[resource_atlas_parent[index]] as any).data[resource_atlas_children_sprites_id[j_index]].default.ax
                                          : Math.abs(
                                                (packet.packet[resource_atlas_parent[index]] as any).data[resource_atlas_children_sprites_id[j_index]].default
                                                    .ax
                                            ),
                                  ay:
                    ...
                    (res_subgroup_children.packet.data as any)[resource_data[index]].srcpath !== undefined &&
                        ...
                        ? {
                              ...
                              srcpath: expand_path_for_array
                                  ...
                                  : (((res_subgroup_children.packet.data as any)[resource_data[index]].srcpath as Array<string> & any).join("\\") as string &
                                        any),
                          }
                        : {
                              slot: 0,
        ...
        public static DoAllProcess<Res_Json_Template extends res_json, Resource_json_Template extends Resources_Group_Structure_Template>(
            res_json: Res_Json_Template,
            file_path: string
            ...
            for (let index: number = 0; index < subgroups_key.length; ++index) {
                if (res_json.groups[subgroups_key[index]].is_composite === true) {
                    ...
                    (resources_json as any).groups.push(
                        this.GenerateOfficialComposite<subgroup_children>(res_json.groups[subgroups_key[index]].subgroup, subgroups_key[index], file_path)
                    );
                    ...
                    if ("resources" in element) {
                        ((resources_json as any).groups[k_lambda_index].resources as Array<blank_slot>).forEach(
                            (resource_element: blank_slot, lambda_index: number) => {
                                ((resources_json as any).groups[k_lambda_index].resources as Array<blank_slot>)[lambda_index].slot = (
                                    resources_json as any
                                ).slot_count;
    ...
    export class SplitUnofficialResources extends CheckOfficialResources {
        ...
        public static DoWholeProcess<Template extends res_json>(
            ...
            Sen.Script.Modules.FileSystem.Json.WriteJson<Output_Value>(Path.Resolve(`${save_directory}/info.json`), info_json);
    ...
    export class MergeUnofficialJson extends CheckOfficialResources {
        ...
        public static DoAllProcess<Template extends Output_Value>(
            ...
            output_file: string = Path.Resolve(`${Path.Dirname(directory_path)}/${Path.Parse(directory_path).name}.json`)
        ): void {
            this.CheckDirectoryInformation(directory_path);
            const info_json_information: Template = Sen.Script.Modules.FileSystem.Json.ReadJson(Path.Resolve(`${directory_path}/info.json`)) as Template;
            ...
            for (let index: number = 0; index < groups_inventory.length; ++index) {
                ...
                for (let j_index: number = 0; j_index < groups_inventory[index].subgroups.length; ++j_index) {
                    res_json.groups[groups_inventory[index].group_parent].subgroup[groups_inventory[index].subgroups[j_index]] =
                        Sen.Script.Modules.FileSystem.Json.ReadJson(Path.Resolve(`${group_directory}/${groups_inventory[index].subgroups[j_index]}.json`));
                }
            }
