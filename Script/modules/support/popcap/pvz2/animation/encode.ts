namespace Sen.Script.Modules.Support.PopCap.PvZ2.Animation {
    ...
    export function CheckPamJson(pam_json: SexyAppFrameworkAnimationPamJson, file_path?: string): pam_json is SexyAppFrameworkAnimationPamJson {
        if (!("version" in pam_json)) {
            throw new Sen.Script.Modules.Exceptions.MissingProperty(Sen.Script.Modules.System.Default.Localization.GetString("property_is_undefined").replace(/\{\}/g, `version`), `version`, (file_path ??= "undefined"));
        }
        ...
        if (pam_json.version !== 1 && pam_json.version !== 2 && pam_json.version !== 3 && pam_json.version !== 4 && pam_json.version !== 5 && pam_json.version !== 6) {
            throw new Sen.Script.Modules.Exceptions.WrongDataType(
                Sen.Script.Modules.System.Default.Localization.RegexReplace(Sen.Script.Modules.System.Default.Localization.GetString("this_property_must_be"), [`version`, `${pam_json.version}`, `1, 2, 3, 4, 5, 6`, `${pam_json.version}`]),
                `version`,
                (file_path ??= "undefined"),
                `1, 2, 3, 4, 5, 6`
            );
        ...
        if (!("frame_rate" in pam_json)) {
            throw new Sen.Script.Modules.Exceptions.MissingProperty(Sen.Script.Modules.System.Default.Localization.GetString("property_is_undefined").replace(/\{\}/g, `frame_rate`), `frame_rate`, (file_path ??= "undefined"));
        }
        ...
        if (!("position" in pam_json)) {
            throw new Sen.Script.Modules.Exceptions.MissingProperty(Sen.Script.Modules.System.Default.Localization.GetString("property_is_undefined").replace(/\{\}/g, `position`), `position`, (file_path ??= "undefined"));
        }
        ...
        if (pam_json.position.length !== 2) {
            throw new Sen.Script.Modules.Exceptions.WrongDataType(
                Sen.Script.Modules.System.Default.Localization.RegexReplace(Sen.Script.Modules.System.Default.Localization.GetString("size_of_array_does_not_match"), [`position`, `2`]),
                `position`,
                (file_path ??= "undefined"),
        ...
        if (!("size" in pam_json)) {
            throw new Sen.Script.Modules.Exceptions.MissingProperty(Sen.Script.Modules.System.Default.Localization.GetString("property_is_undefined").replace(/\{\}/g, `size`), `size`, (file_path ??= "undefined"));
        }
        ...
        if (!("sprite" in pam_json)) {
            throw new Sen.Script.Modules.Exceptions.MissingProperty(Sen.Script.Modules.System.Default.Localization.GetString("property_is_undefined").replace(/\{\}/g, `sprite`), `sprite`, (file_path ??= "undefined"));
        }
        ...
        if (!("main_sprite" in pam_json)) {
            throw new Sen.Script.Modules.Exceptions.MissingProperty(Sen.Script.Modules.System.Default.Localization.GetString("property_is_undefined").replace(/\{\}/g, `main_sprite`), `main_sprite`, (file_path ??= "undefined"));
        }
        return true;
    }
    ...
    export function PopCapAnimationJsonToAnimateAdobeFlashAnimation(inFile: string, outputDirectory: string, resolution: int): string {
        ...
        Sen.Script.Modules.FileSystem.Json.WriteJson<Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonForUser>(Path.Resolve(`${outputDirectory}/extra.json`), Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonConvert(extra_json));
    ...
    export function AnimateAdobeFlashAnimationToPopCapAnimationJson(inDirectory: string, outFile: string): void {
        const extra_json: Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraInfo = Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonConvertBack(
            Sen.Script.Modules.FileSystem.Json.ReadJson<Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonForUser>(Path.Resolve(`${inDirectory}/extra.json`))
        );
        const pam_json: Sen.Script.Modules.Support.PopCap.PvZ2.Animation.SexyAppFrameworkAnimationPamJson = PvZ2Shell.FlashAnimationtoPAMJSON(inDirectory, extra_json);
        Sen.Script.Modules.FileSystem.Json.WriteJson<Sen.Script.Modules.Support.PopCap.PvZ2.Animation.SexyAppFrameworkAnimationPamJson>(outFile, pam_json);
        return;
    }
    ...
    export function PopCapAnimationToAnimateAdobeFlashAnimation(inFile: string, outputDirectory: string, resolution: int): void {
        ...
        Sen.Script.Modules.FileSystem.Json.WriteJson<Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonForUser>(Path.Resolve(`${outputDirectory}/extra.json`), extra);
        return;
    }
    ...
    export function ExtraJsonConvert(information: Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraInfo): Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonForUser {
    ...
    export function ExtraJsonConvertBack(information: Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraJsonForUser): Sen.Script.Modules.Support.PopCap.PvZ2.Animation.ExtraInfo {
