declare namespace Sen {
    ...
    declare namespace Shell {
        ...
        export class SenBuffer {
            ...
            readVarUInt32(offset: number): number;
            readVarUInt32(): number;
            readVarUInt64(offset: number): number;
            ...
            readnumber64LE(): number;
            readnumber64LE(offset: number): number;
            readnumber64BE(): number;
            readnumber64BE(offset: number): number;
            readString(count: number): string;
            readString(count: number, offset: number): string;
            readString(count: number, offset: number, encodingType: string): string;
            readBytes(count: number): Array<number>;
            readBytes(count: number, offset: number): Array<number>;
            readVarInt32(offset: number): number;
            readVarInt32(): number;
            readVarInt64(offset: number): number;
            readVarInt64(): number;
            readZigZag32(): number;
            readZigZag32(offset: number): number;
            readZigZag64(): number;
            readZigZag64(offset: number): number;
            readBool(): boolean;
            readBool(offset: number): boolean;
            readStringByEmpty(): string;
            readStringByEmpty(offset: number): string;
            getStringByEmpty(): string;
            getStringByEmpty(offset: number): string;
            readStringByInt16LE(): string;
            readStringByInt16LE(offset: number): string;
            readStringByVarInt32(): string;
            readStringByVarInt32(offset: number): string;
            writeBytes(array: Array<number>): void;
            writeBytes(array: Array<number>, offset: number): void;
            writeString(str: string): void;
            writeString(str: string, offset: number): void;
            writeString(str: string, offset: number, encodingType: string = "UTF-8"): void;
            writeStringByEmpty(str: string): void;
            writeStringByEmpty(str: string, offset: number): void;
            writeNull(count: number): void;
            writeNull(count: number, offset: number): void;
            writeStringFourByte(str: string): void;
            writeStringFourByte(str: string, offset: number): void;
            setBytes(array: Array<number>, offset: number, overwriteOffset: boolean): void;
            writeUInt8(num: number): void;
            writeUInt8(num: number, offset: number): void;
            writeUInt16LE(num: number): void;
            writeUInt16LE(num: number, offset: number): void;
            writeUInt16BE(num: number): void;
            writeUInt16BE(num: number, offset: number): void;
            writeUInt24LE(num: number): void;
            writeUInt24LE(num: number, offset: number): void;
            writeUInt24BE(num: number): void;
            writeUInt24BE(num: number, offset: number): void;
            writeUInt32LE(num: number): void;
            writeUInt32LE(num: number, offset: number): void;
            writeUInt32BE(num: number): void;
            writeUInt32BE(num: number, offset: number): void;
            writeBigUInt64LE(num: number): void;
            writeBigUInt64LE(num: number, offset: number): void;
            writeBigUInt64BE(num: number): void;
            writeBigUInt64BE(num: number, offset: number): void;
            writeUVarInt32(num: number): void;
            writeUVarInt32(num: number, offset: number): void;
            writeUVarInt64(num: number): void;
            writeUVarInt64(num: number, offset: number): void;
            writeInt8(num: number): void;
            writeInt8(num: number, offset: number): void;
            writeInt16LE(num: number): void;
            writeInt16LE(num: number, offset: number): void;
            writeInt16BE(num: number): void;
            writeInt16BE(num: number, offset: number): void;
            writeInt24LE(num: number): void;
            writeInt24LE(num: number, offset: number): void;
            writeInt24BE(num: number): void;
            writeInt24BE(num: number, offset: number): void;
            writeInt32LE(num: number): void;
            writeInt32LE(num: number, offset: number): void;
            writeInt32BE(num: number): void;
            writeInt32BE(num: number, offset: number): void;
            writenumber64LE(num: number): void;
            writenumber64LE(num: number, offset: number): void;
            writenumber64BE(num: number): void;
            writenumber64BE(num: number, offset: number): void;
            writeVarInt32(num: number): void;
            writeVarInt32(num: number, offset: number): void;
            writeVarInt64(num: number): void;
            writeVarInt64(num: number, offset: number): void;
            writeBool(val: boolean): void;
            writeBool(val: boolean, offset: number): void;
            writeZigZag32(val: number): void;
            writeZigZag32(val: number, offset: number): void;
            writeZigZag64(val: number): void;
            writeZigZag64(val: number, offset: number): void;
            writeStringByInt16LE(): void;
            writeStringByInt16LE(str: string): void;
            writeStringByInt16LE(str: string, offset: number): void;
            writeStringByVarInt32(): void;
            writeStringByVarInt32(str: string): void;
            writeStringByVarInt32(str: string, offset: number): void;
            writeSenBuffer(sen: SenBuffer): void;
            writeSenBuffer(sen: SenBuffer, offset: number): void;
            toBytes(): Array<number>;
            getBytes(count: number, count: offset): Array<number>;
            toString(): string;
            toString(encodingType: string): string;
            BackupReadOffset(): void;
            RestoreReadOffset(): void;
            ...
            Flush(): void;
            SerializeJson<T>(json: T): string;
            SerializeJson<T>(json: T, indent: number | string): string;
            readInt16BE(): number;
            ...
            peekUInt24LE(): number;
            peekUInt24LE(offset: number): number;
            peekUInt24BE(): number;
            peekUInt24BE(offset: number): number;
            peekUInt32LE(): number;
            ...
            peekInt24LE(): number;
            peekInt24LE(offset: number): number;
            peekInt24BE(): number;
            peekInt24BE(offset: number): number;
            peekInt32LE(): number;
            peekInt32LE(offset: number): number;
            peekInt32BE(): number;
            peekInt32BE(offset: number): number;
            peekString(count: number): string;
            peekString(count: number, offset: number): string;
            peekString(count: number, offset: number, encodingType: string): string;
            size(): number;
            current(): number;
            readInt24BE(): number;
        ...
        declare namespace FileSystem {
            ...
            export function ReadJson<T>(file_path: string): T;
            /**
             *
             * @param file_path - Provide file path here, must be file path.
