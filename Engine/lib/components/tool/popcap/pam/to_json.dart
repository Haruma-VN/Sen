...
class PopCapAnimationConvertToJson extends StatefulWidget {
  const PopCapAnimationConvertToJson({super.key});

  @override
  State<PopCapAnimationConvertToJson> createState() =>
      _PopCapAnimationConvertToJsonState();
}

class _PopCapAnimationConvertToJsonState
                  ...
                  child: Align(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!
                          .popcap_animation_decode_to_json,
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            ...
                            if (path != null) {
                              ...
                              controllerOutput.text = '$path.json';
                              setState(() {
                                allowExecute = true;
                              });
                            }
