...
class PopCapAnimationConvertFromFlash extends StatefulWidget {
  const PopCapAnimationConvertFromFlash({super.key});

  @override
  State<PopCapAnimationConvertFromFlash> createState() =>
      _PopCapAnimationConvertFromFlashState();
}

class _PopCapAnimationConvertFromFlashState
    extends State<PopCapAnimationConvertFromFlash> {
                  ...
                  child: Align(
                    ...
                    child: Text(
                      AppLocalizations.of(context)!
                          .popcap_animation_pam_from_flash,
